...
function BackgroundFX() {
  ...
  return (
    <Box
      ...
      aria-hidden
      sx={{
        // Sits IN FRONT of the landing artwork (z-index 1) but below the
        // header (z-index 50); pointerEvents:none keeps everything clickable.
        position: 'fixed',
        inset: 0,
        width: '100%',
        height: '100%',
...
function Header({ onPortal }) {
  ...
  return (
    ...
    >
      ...
      <Stack direction="row" spacing={1.2} alignItems="center" sx={{ ml: 'auto' }}>
        <ThemeToggle />
